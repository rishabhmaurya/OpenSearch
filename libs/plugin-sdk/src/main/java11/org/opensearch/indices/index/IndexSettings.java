...
import org.opensearch.indices.index.translog.constant.Translog;
import org.opensearch.indices.index.translog.constant.Durability;
import org.opensearch.ingest.constants.IngestService;
import org.opensearch.node.constant.Node;
...
import static org.opensearch.indices.index.mapper.constants.MapperService.INDEX_MAPPING_DEPTH_LIMIT_SETTING;
import static org.opensearch.indices.index.mapper.constants.MapperService.INDEX_MAPPING_FIELD_NAME_LENGTH_LIMIT_SETTING;
import static org.opensearch.indices.index.mapper.constants.MapperService.INDEX_MAPPING_NESTED_DOCS_LIMIT_SETTING;
import static org.opensearch.indices.index.mapper.constants.MapperService.INDEX_MAPPING_NESTED_FIELDS_LIMIT_SETTING;
import static org.opensearch.indices.index.mapper.constants.MapperService.INDEX_MAPPING_TOTAL_FIELDS_LIMIT_SETTING;
 ...
 * a settings consumer at index creation via #RF that will
...
public final class IndexSettings {
    ...
    public static final Setting<Durability> INDEX_TRANSLOG_DURABILITY_SETTING =
        new Setting<>("index.translog.durability", Durability.REQUEST.name(),
            (value) -> Durability.valueOf(value.toUpperCase(Locale.ROOT)), Property.Dynamic, Property.IndexScope);
    ...
    // #RF-6 rivate final IndexSortConfig indexSortConfig;
    ...
    private void setTranslogDurability(Durability durability) {
     ...
     * {@link org.opensearch.common.threadpool.ThreadPool.Names#SEARCH_THROTTLED} thread-pool
     */
