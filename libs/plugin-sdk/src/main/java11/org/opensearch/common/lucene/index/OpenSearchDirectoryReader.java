...
public final class OpenSearchDirectoryReader extends FilterDirectoryReader {
    ...
    public static void addReaderCloseListener(DirectoryReader reader, ClosedListener listener) {
        ...
        CacheHelper cacheHelper = openSearchDirectoryReader.getReaderCacheHelper();
        if (cacheHelper == null) {
