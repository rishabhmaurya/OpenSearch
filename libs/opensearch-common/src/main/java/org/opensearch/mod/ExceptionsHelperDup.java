...
public final class ExceptionsHelperDup {

    private static final Logger logger = LogManager.getLogger(ExceptionsHelperDup.class);

    public static RuntimeException convertToRuntime(Exception e) {
        if (e instanceof RuntimeException) {
            return (RuntimeException) e;
        }
        return new OpenSearchExceptionDup(e);
    }

    public static OpenSearchExceptionDup convertToOpenSearchExceptionDup(Exception e) {
        if (e instanceof OpenSearchExceptionDup) {
            return (OpenSearchExceptionDup) e;
        }
        return new OpenSearchExceptionDup(e);
    }
    ...
    public static RestStatus status(Throwable t) {
        if (t != null) {
            if (t instanceof OpenSearchExceptionDup) {
                return ((OpenSearchExceptionDup) t).status();
    ...
    public static <T extends Throwable> void maybeThrowRuntimeAndSuppress(List<T> exceptions) {
        ...
        if (main != null) {
            throw new OpenSearchExceptionDup(main);
        }
    }
    ...
    public static IOException unwrapCorruption(Throwable t) {
        return t == null ? null : ExceptionsHelperDup.<IOException>unwrapCausesAndSuppressed(t, cause -> {
    ...
    public static void maybeDieOnAnotherThread(final Throwable throwable) {
        ExceptionsHelperDup.maybeError(throwable).ifPresent(error -> {
            /*
            ...
            try {
                ...
                final String formatted = ExceptionsHelperDup.formatStackTrace(Thread.currentThread().getStackTrace());
     ...
     */
    /* #RF - moved out of common module to avoid dependency on Shards module
    ...
    private static class GroupBy {
        ...
        GroupBy(ShardOperationFailedException failure) {
            ...
            if (indexName == null) {
                if (cause instanceof OpenSearchExceptionDup) {
                    final Index index = ((OpenSearchExceptionDup) cause).getIndex();
                    if (index != null) {
