...
public class ActionModuleTests extends OpenSearchTestCase {
    public void testSetupActionsContainsKnownBuiltin() {
        assertThat(ActionModule.setupActions(emptyList(), emptyList()),
    ...
    public void testPluginCantOverwriteBuiltinAction() {
        ...
        Exception e = expectThrows(IllegalArgumentException.class, () -> ActionModule.setupActions(singletonList(dupsMainAction), emptyList()));
    ...
    public void testPluginCanRegisterAction() {
        ...
        assertThat(ActionModule.setupActions(singletonList(registersFakeAction), emptyList()),
