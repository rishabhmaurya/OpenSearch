...
import org.opensearch.mod.common.inject.internal.Annotations;
import org.opensearch.mod.common.inject.internal.BindingImpl;
import org.opensearch.mod.common.inject.internal.Errors;
import org.opensearch.mod.common.inject.internal.ErrorsException;
import org.opensearch.mod.common.inject.internal.ExposedBindingImpl;
import org.opensearch.mod.common.inject.internal.InstanceBindingImpl;
import org.opensearch.mod.common.inject.internal.InternalFactory;
import org.opensearch.mod.common.inject.internal.LinkedBindingImpl;
import org.opensearch.mod.common.inject.internal.LinkedProviderBindingImpl;
import org.opensearch.mod.common.inject.internal.ProviderInstanceBindingImpl;
import org.opensearch.mod.common.inject.internal.ProviderMethod;
import org.opensearch.mod.common.inject.internal.Scoping;
import org.opensearch.mod.common.inject.internal.UntargettedBindingImpl;
import org.opensearch.mod.common.inject.spi.BindingTargetVisitor;
import org.opensearch.mod.common.inject.spi.ConstructorBinding;
import org.opensearch.mod.common.inject.spi.ConvertedConstantBinding;
import org.opensearch.mod.common.inject.spi.ExposedBinding;
import org.opensearch.mod.common.inject.spi.InjectionPoint;
import org.opensearch.mod.common.inject.spi.InstanceBinding;
import org.opensearch.mod.common.inject.spi.LinkedKeyBinding;
import org.opensearch.mod.common.inject.spi.PrivateElements;
import org.opensearch.mod.common.inject.spi.ProviderBinding;
import org.opensearch.mod.common.inject.spi.ProviderInstanceBinding;
import org.opensearch.mod.common.inject.spi.ProviderKeyBinding;
import org.opensearch.mod.common.inject.spi.UntargettedBinding;
        ...
        command.acceptTargetVisitor(new BindingTargetVisitor<T, Void>() {
            ...
            public Void visit(ProviderKeyBinding<? extends T> binding) {
                ...
                InternalFactory<? extends T> scopedFactory = Scopes.scope(
                        key, injector, boundProviderFactory, scoping);
