...
package org.opensearch.mod.common.inject.multibindings;

import org.opensearch.mod.common.inject.Binder;
import org.opensearch.mod.common.inject.Binding;
import org.opensearch.mod.common.inject.ConfigurationException;
...
import org.opensearch.mod.common.inject.binder.LinkedBindingBuilder;
import org.opensearch.mod.common.inject.internal.Errors;
import org.opensearch.mod.common.inject.spi.Dependency;
import org.opensearch.mod.common.inject.spi.HasDependencies;
import org.opensearch.mod.common.inject.spi.Message;
import org.opensearch.mod.common.inject.util.Types;
...
public abstract class Multibinder<T> {
    ...
    public static <T> Multibinder<T> newSetBinder(Binder binder, TypeLiteral<T> type) {
        ...
        RealMultibinder<T> result = new RealMultibinder<>(binder, type, "",
                Key.get(Multibinder.setOf(type)));
    ...
    public static <T> Multibinder<T> newSetBinder(
        ...
        RealMultibinder<T> result = new RealMultibinder<>(binder, type, annotation.toString(),
                Key.get(Multibinder.setOf(type), annotation));
        binder.install(result);
        return result;
    }
    ...
    public static <T> Multibinder<T> newSetBinder(Binder binder, TypeLiteral<T> type,
        ...
        RealMultibinder<T> result = new RealMultibinder<>(binder, type, "@" + annotationType.getName(),
                Key.get(Multibinder.setOf(type), annotationType));
        binder.install(result);
        return result;
    }
