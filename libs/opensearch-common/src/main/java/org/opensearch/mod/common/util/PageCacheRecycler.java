...
package org.opensearch.mod.common.util;
...
import static org.opensearch.mod.common.recycler.Recyclers.concurrent;
import static org.opensearch.mod.common.recycler.Recyclers.concurrentDeque;
import static org.opensearch.mod.common.recycler.Recyclers.dequeFactory;
import static org.opensearch.mod.common.recycler.Recyclers.none;
...
public class PageCacheRecycler {
    ...
    // #RF - moved from OpenSearchExecutors.java
    private static final DeprecationLogger deprecationLogger = DeprecationLogger.getLogger(PageCacheRecycler.class);
    ...
    public PageCacheRecycler(Settings settings) {
        ...
        final int allocatedProcessors = allocatedProcessors(settings);
