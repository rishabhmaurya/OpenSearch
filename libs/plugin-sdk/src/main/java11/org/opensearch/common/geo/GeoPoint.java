...
import static org.opensearch.indices.index.mapper.constants.AbstractPointGeometryFieldMapper.Names.IGNORE_Z_VALUE;
...
public class GeoPoint implements ToXContentFragment {
    ...
    public GeoPoint resetFromString(String value) {
        return resetFromString(value, false, GeoPoint.EffectivePoint.BOTTOM_LEFT);
    }

    public GeoPoint resetFromString(String value, final boolean ignoreZValue, GeoPoint.EffectivePoint effectivePoint) {
    ...
    GeoPoint parseGeoHash(String geohash, GeoPoint.EffectivePoint effectivePoint) {
        if (effectivePoint == GeoPoint.EffectivePoint.BOTTOM_LEFT) {
