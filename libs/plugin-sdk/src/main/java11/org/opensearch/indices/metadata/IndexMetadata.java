...
package org.opensearch.indices.metadata;

import com.carrotsearch.hppc.LongArrayList;
import com.carrotsearch.hppc.cursors.IntObjectCursor;
import com.carrotsearch.hppc.cursors.ObjectCursor;
import com.carrotsearch.hppc.cursors.ObjectObjectCursor;
import org.opensearch.common.Assertions;
import org.opensearch.common.LegacyESVersion;
import org.opensearch.common.Version;
import org.opensearch.action.admin.indices.rollover.RolloverInfo;
import org.opensearch.action.support.ActiveShardCount;
import org.opensearch.cluster.metadata.AliasMetadata;
import org.opensearch.cluster.metadata.AutoExpandReplicas;
import org.opensearch.common.diff.DiffableStringMap;
import org.opensearch.indices.index.mapper.metadata.MappingMetadata;
import org.opensearch.common.diff.Diff;
import org.opensearch.common.diff.Diffable;
import org.opensearch.common.diff.DiffableUtils;
import org.opensearch.cluster.block.ClusterBlock;
import org.opensearch.cluster.block.ClusterBlockLevel;
import org.opensearch.cluster.metadata.constant.Metadata;
...
import org.opensearch.indices.index.Index;
import org.opensearch.indices.index.mapper.constants.MapperService;
import org.opensearch.indices.index.seqno.SequenceNumbers;
import org.opensearch.indices.index.shard.ShardId;
...
import static org.opensearch.cluster.metadata.constant.Metadata.CONTEXT_MODE_PARAM;
...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment {
     ...
     * that can be indexed into) is larger than 0. See #RF-1.
     **/
    ...
    public static class Builder {
        ...
        public static IndexMetadata fromXContent(XContentParser parser) throws IOException {
            ...
            assert !Assertions.ENABLED || !Version.indexCreated(builder.settings).onOrAfter(LegacyESVersion.V_6_5_0) || mappingVersion : "mapping version should be present for indices created on or after 6.5.0";
            assert !Assertions.ENABLED || !Version.indexCreated(builder.settings).onOrAfter(LegacyESVersion.V_6_5_0) || settingsVersion : "settings version should be present for indices created on or after 6.5.0";
            assert !Assertions.ENABLED || !Version.indexCreated(builder.settings).onOrAfter(LegacyESVersion.V_7_2_0) || aliasesVersion : "aliases version should be present for indices created on or after 7.2.0";
            return builder.build();
        }
    }
