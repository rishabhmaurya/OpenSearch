...
public class MergePolicySettingsTests extends OpenSearchTestCase {
    ...
    public void testTieredMergePolicySettingsUpdate() throws IOException {
        ...
        assertEquals(((OpenSearchTieredMergePolicy) indexSettings.getMergePolicy()).getForceMergeDeletesPctAllowed(),
        ...
        assertEquals(((OpenSearchTieredMergePolicy) indexSettings.getMergePolicy()).getFloorSegmentMB(),
        ...
        assertEquals(((OpenSearchTieredMergePolicy) indexSettings.getMergePolicy()).getMaxMergeAtOnce(),
        ...
        assertEquals(((OpenSearchTieredMergePolicy) indexSettings.getMergePolicy()).getMaxMergeAtOnceExplicit(),
        ...
        assertEquals(((OpenSearchTieredMergePolicy) indexSettings.getMergePolicy()).getMaxMergedSegmentMB(),
        ...
        assertEquals(((OpenSearchTieredMergePolicy) indexSettings.getMergePolicy()).getSegmentsPerTier(),
