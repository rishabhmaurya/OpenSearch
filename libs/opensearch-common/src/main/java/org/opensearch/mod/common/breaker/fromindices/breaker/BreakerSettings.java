...
package org.opensearch.mod.common.breaker.fromindices.breaker;
...
public final class BreakerSettings {
    ...
    public static String breakerLimitSettingKey(String breakerName) {
    ...
    public static String breakerOverheadSettingKey(String breakerName) {
    ...
    public static String breakerTypeSettingKey(String breakerName) {
