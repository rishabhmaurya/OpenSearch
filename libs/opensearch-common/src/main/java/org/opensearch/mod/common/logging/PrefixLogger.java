 ...
 */
// #RF - since we moved and renamed packages. Public access should be removed once code is modularized
// appropriately
public class PrefixLogger extends ExtendedLoggerWrapper {
     ...
     */
    // #RF - due to rename of package
    public PrefixLogger(final Logger logger, final String prefix) {
