...
package org.opensearch.indices.index.mapper.metadata;

import org.opensearch.common.LegacyESVersion;
import org.opensearch.common.OpenSearchParseException;
import org.opensearch.common.diff.AbstractDiffable;
...
import org.opensearch.indices.index.mapper.constants.DateFieldMapper;
...
public class MappingMetadata extends AbstractDiffable<MappingMetadata> {
    ...
    /*
    // #RF-6: can we move this construction logic to the right module instead of creating dependency on DocumentMapper here
    ...
    // #RF make public
    public void updateDefaultMapping(MappingMetadata defaultMapping) {
