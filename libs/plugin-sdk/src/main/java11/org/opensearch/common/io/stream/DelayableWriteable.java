...
public abstract class DelayableWriteable<T extends Writeable> implements Writeable {
     ...
     */
    public static <T extends Writeable> DelayableWriteable<T> delayed(Reader<T> reader, StreamInput in) throws IOException {
     ...
     * in serialized form.
     */
    public abstract Serialized<T> asSerialized(Reader<T> reader, NamedWriteableRegistry registry);
    ...
    public static class Serialized<T extends Writeable> extends DelayableWriteable<T> implements Accountable {
        ...
        private Serialized(Reader<T> reader, Version serializedAtVersion, NamedWriteableRegistry registry, BytesReference serialized) {
            this.reader = reader;
