...
public class MetadataCreateIndexServiceTests extends OpenSearchTestCase {
    ...
    private void runPrepareResizeIndexSettingsTest(
        ...
        final RoutingTable routingTable
            = OpenSearchAllocationTestCase.startInitializingShardsAndReroute(service, routingTableClusterState, indexName).routingTable();
    ...
    public void testClusterStateCreateIndexThrowsWriteIndexValidationException() throws Exception {
        ...
        assertThat(
            expectThrows(IllegalStateException.class,
                () -> clusterStateCreateIndex(currentClusterState, org.opensearch.common.collect.Set.of(), newIndex,
    ...
    public void testClusterStateCreateIndexWithMetadataTransaction() {
        ...
        ClusterState updatedClusterState = clusterStateCreateIndex(currentClusterState, org.opensearch.common.collect.Set.of(
