...
package org.opensearch.mod.common;
 ...
 */
public class ParsingExceptionDup extends OpenSearchExceptionDup {

    protected static final int UNKNOWN_POSITION = -1;
    private final int lineNumber;
    private final int columnNumber;

    public ParsingExceptionDup(XContentLocation contentLocation, String msg, Object... args) {
        this(contentLocation, msg, null, args);
    }

    public ParsingExceptionDup(XContentLocation contentLocation, String msg, Throwable cause, Object... args) {
     ...
     */
    public ParsingExceptionDup(int line, int col, String msg, Throwable cause) {
        super(msg, cause);
        this.lineNumber = line;
        this.columnNumber = col;
    }

    public ParsingExceptionDup(StreamInput in) throws IOException{
        super(in);
