...
package org.opensearch.mod.common.settings;
...
import org.opensearch.mod.common.unit.MemorySizeValue;
...
import static org.opensearch.mod.common.unit.ByteSizeValue.parseBytesSizeValue;
...
public final class Settings implements ToXContentFragment {
     ...
     * leading to a runtime failure (see #RF. The premature construction would come from any
     * {@link Setting} object constructed in, for example, #RF.
     */
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        Settings settings = SettingsFilterDup.filterSettings(params, this);
