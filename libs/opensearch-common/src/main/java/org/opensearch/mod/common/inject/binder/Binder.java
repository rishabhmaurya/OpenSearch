...
package org.opensearch.mod.common.inject.binder;

import org.opensearch.mod.common.inject.AbstractModule;
import org.opensearch.mod.common.inject.ImplementedBy;
import org.opensearch.mod.common.inject.Injector;
...
import org.opensearch.mod.common.inject.ProvidedBy;
import org.opensearch.mod.common.inject.Provider;
import org.opensearch.mod.common.inject.Scope;
import org.opensearch.mod.common.inject.Scopes;
import org.opensearch.mod.common.inject.Singleton;
...
import org.opensearch.mod.common.inject.spi.TypeConverter;
import org.opensearch.mod.common.inject.spi.TypeListener;
 ...
 * standard annotation, {@link org.opensearch.mod.common.inject.name.Named @Named}.  Because of
...
// #RF - moved from inject to inject to binder to avoid error -
// "Binder clashes with package of same name"
