...
import static org.opensearch.indices.metadata.IndexMetadata.INDEX_UUID_NA_VALUE;
...
public class OpenSearchException extends RuntimeException implements ToXContentFragment, Writeable {
    ...
    public String toString() {
        ...
        /*#RF-3 if (metadata.containsKey(INDEX_METADATA_KEY)) {
    ...
    private enum OpenSearchExceptionHandle {
        ...
        OpenSearchParseException(
            org.opensearch.common.OpenSearchParseException.class,
            org.opensearch.common.OpenSearchParseException::new,
            160,
            LegacyESVersion.V_7_10_0
        );
