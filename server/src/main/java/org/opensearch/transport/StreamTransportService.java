...
public class StreamTransportService extends TransportService {
    ...
    public StreamTransportService(
        ...
        super(
            ...
            clusterSettings,
            taskHeaders,
            new ClusterConnectionManager(ConnectionProfile.buildSingleChannelProfile(
    ...
    @Override
    protected void sendLocalRequest(
        long requestId,
        final String action,
        final TransportRequest request,
    ...
    class StreamDirectResponseChannel implements TransportChannel {
        ...
        @Override
        public void sendStreamResponse(StreamTransportResponse<?> response) throws IOException {
            service.onStreamResponseSent(requestId, action, response);
            final TransportResponseHandler<?> handler = responseHandlers.onResponseReceived(requestId, service);
            if (handler != null) {
        ...
        private void processResponse(TransportResponseHandler handler, StreamTransportResponse response) {
            try {
