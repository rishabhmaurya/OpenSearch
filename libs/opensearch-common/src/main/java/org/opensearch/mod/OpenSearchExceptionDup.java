 ...
 */
public class OpenSearchExceptionDup extends RuntimeException implements ToXContentFragment, Writeable {
    ...
    private static final Map<Integer, CheckedFunction<StreamInput, ? extends OpenSearchExceptionDup, IOException>> ID_TO_SUPPLIER;
    private static final Map<Class<? extends OpenSearchExceptionDup>, OpenSearchExceptionDupHandle> CLASS_TO_OPENSEARCH_EXCEPTION_HANDLE;
    ...
    /**
     * Construct a <code>OpenSearchExceptionDup</code> with the specified cause exception.
     */
    public OpenSearchExceptionDup(Throwable cause) {
        super(cause);
    }

    /**
     * Construct a <code>OpenSearchExceptionDup</code> with the specified detail message.
     *
     ...
     */
    public OpenSearchExceptionDup(String msg, Object... args) {
     ...
     * @param args  the arguments for the message
     */
    public OpenSearchExceptionDup(String msg, Throwable cause, Object... args) {
        super(LoggerMessageFormat.format(msg, args), cause);
    }

    public OpenSearchExceptionDup(StreamInput in) throws IOException {
        super(in.readOptionalString(), in.readException());
        readStackTrace(this, in);
        headers.putAll(in.readMapOfLists(StreamInput::readString, StreamInput::readString));
        metadata.putAll(in.readMapOfLists(OpenSearchExceptionDup::readAndReplace, StreamInput::readString));
    }
    ...
    public RestStatus status() {
        ...
        if (cause == this) {
            ...
            return ExceptionsHelperDup.status(cause);
        }
    }
     ...
     *
     * @see ExceptionsHelperDup#unwrapCause(Throwable)
     */
    public Throwable unwrapCause() {
        return ExceptionsHelperDup.unwrapCause(this);
    }
    ...
    public String getDetailedMessage() {
        if (getCause() != null) {
            ...
            if (getCause() instanceof OpenSearchExceptionDup) {
                sb.append(((OpenSearchExceptionDup) getCause()).getDetailedMessage());
            } else {
                sb.append(getCause());
            }
            return sb.toString();
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeMapOfLists(metadata, OpenSearchExceptionDup::replaceAndWrite, StreamOutput::writeString);
    }

    public static OpenSearchExceptionDup readException(StreamInput input, int id) throws IOException {
        CheckedFunction<StreamInput, ? extends OpenSearchExceptionDup, IOException> opensearchException = ID_TO_SUPPLIER.get(id);
    ...
    public static boolean isRegistered(Class<? extends Throwable> exception, Version version) {
        OpenSearchExceptionDupHandle openSearchExceptionHandle = CLASS_TO_OPENSEARCH_EXCEPTION_HANDLE.get(exception);
    ...
    static Set<Class<? extends OpenSearchExceptionDup>> getRegisteredKeys() { // for testing
     ...
     */
    public static int getId(Class<? extends OpenSearchExceptionDup> exception) {
        return CLASS_TO_OPENSEARCH_EXCEPTION_HANDLE.get(exception).id;
    }

    @Override
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        Throwable ex = ExceptionsHelperDup.unwrapCause(this);
        if (ex != this) {
    ...
    protected static void innerToXContent(XContentBuilder builder, Params params,
        ...
        if (throwable instanceof OpenSearchExceptionDup) {
            OpenSearchExceptionDup exception = (OpenSearchExceptionDup) throwable;
        ...
        if (params.paramAsBoolean(REST_EXCEPTION_SKIP_STACK_TRACE, REST_EXCEPTION_SKIP_STACK_TRACE_DEFAULT) == false) {
            builder.field(STACK_TRACE, ExceptionsHelperDup.stackTrace(throwable));
        }
    ...
    /**
     * Generate a {@link OpenSearchExceptionDup} from a {@link XContentParser}. This does not
     ...
     * tree structure of the cause, returning it as a tree structure of {@link OpenSearchExceptionDup}
     * instances.
     */
    public static OpenSearchExceptionDup fromXContent(XContentParser parser) throws IOException {
        XContentParser.Token token = parser.nextToken();
        ensureExpectedToken(XContentParser.Token.FIELD_NAME, token, parser);
        return innerFromXContent(parser, false);
    }

    public static OpenSearchExceptionDup innerFromXContent(XContentParser parser, boolean parseRootCauses) throws IOException {
        XContentParser.Token token = parser.currentToken();
        ensureExpectedToken(XContentParser.Token.FIELD_NAME, token, parser);

        String type = null, reason = null, stack = null;
        OpenSearchExceptionDup cause = null;
        Map<String, List<String>> metadata = new HashMap<>();
        Map<String, List<String>> headers = new HashMap<>();
        List<OpenSearchExceptionDup> rootCauses = new ArrayList<>();
        List<OpenSearchExceptionDup> suppressed = new ArrayList<>();
        ...
        OpenSearchExceptionDup e = new OpenSearchExceptionDup(buildMessage(type, reason, stack), cause);
        for (Map.Entry<String, List<String>> entry : metadata.entrySet()) {
        ...
        for (OpenSearchExceptionDup rootCause : rootCauses) {
            e.addSuppressed(rootCause);
        }
        for (OpenSearchExceptionDup s : suppressed) {
            e.addSuppressed(s);
        }
        return e;
    }
    ...
    /**
     * Static toXContent helper method that renders {@link OpenSearchExceptionDup} or {@link Throwable} instances
    ...
    public static void generateThrowableXContent(XContentBuilder builder, Params params, Throwable t) throws IOException {
        t = ExceptionsHelperDup.unwrapCause(t);

        if (t instanceof OpenSearchExceptionDup) {
            ((OpenSearchExceptionDup) t).toXContent(builder, params);
        } else {
    ...
    public static void generateFailureXContent(XContentBuilder builder, Params params, @Nullable Exception e, boolean detailed)
        ...
        if (detailed == false) {
            String message = "No OpenSearchExceptionDup found";
            Throwable t = e;
        ...
        final OpenSearchExceptionDup[] rootCauses = OpenSearchExceptionDup.guessRootCauses(e);
     ...
     */
    public static OpenSearchExceptionDup failureFromXContent(XContentParser parser) throws IOException {
        XContentParser.Token token = parser.currentToken();
        ensureFieldName(parser, token, ERROR);

        token = parser.nextToken();
        if (token.isValue()) {
            return new OpenSearchExceptionDup(buildMessage("exception", parser.text(), null));
        }
     ...
     */
    public OpenSearchExceptionDup[] guessRootCauses() {
        final Throwable cause = getCause();
        if (cause != null && cause instanceof OpenSearchExceptionDup) {
            return ((OpenSearchExceptionDup) cause).guessRootCauses();
        }
        return new OpenSearchExceptionDup[]{this};
    }

    /**
     * Returns the root cause of this exception or multiple if different shards caused different exceptions.
     * If the given exception is not an instance of {@link OpenSearchExceptionDup} an empty array
     * is returned.
     */
    public static OpenSearchExceptionDup[] guessRootCauses(Throwable t) {
        Throwable ex = ExceptionsHelperDup.unwrapCause(t);
        if (ex instanceof OpenSearchExceptionDup) {
            // OpenSearchExceptionDup knows how to guess its own root cause
            return ((OpenSearchExceptionDup) ex).guessRootCauses();
        }
        if (ex instanceof XContentParseException) {
             ...
             * an OpenSearchExceptionDup we'd like to keep unwrapping because
             * ElasticserachExceptions tend to contain useful information for
             * the user.
             */
            Throwable cause = ex.getCause();
            if (cause != null) {
                if (cause instanceof XContentParseException || cause instanceof OpenSearchExceptionDup) {
                    return guessRootCauses(ex.getCause());
                }
            }
        }
        return new OpenSearchExceptionDup[]{new OpenSearchExceptionDup(ex.getMessage(), ex) {
            @Override
    ...
    public String toString() {
        ...
        return builder.append(ExceptionsHelperDup.detailedMessage(this).trim()).toString();
    }
     ...
     */
    private enum OpenSearchExceptionDupHandle {
        OPENSEARCH_GENERATION_EXCEPTION(OpenSearchGenerationException.class,
            OpenSearchGenerationException::new, 21, UNKNOWN_VERSION_ADDED),
        OPENSEARCH_PARSE_EXCEPTION(OpenSearchParseException.class,
        ...
        final Class<? extends OpenSearchExceptionDup> exceptionClass;
        final CheckedFunction<StreamInput, ? extends OpenSearchExceptionDup, IOException> constructor;
        final int id;
        final Version versionAdded;

        <E extends OpenSearchExceptionDup> OpenSearchExceptionDupHandle(Class<E> exceptionClass,
     ...
     */
    static int[] ids() {
        return Arrays.stream(OpenSearchExceptionDupHandle.values()).mapToInt(h -> h.id).toArray();
    }
     ...
     */
    static Tuple<Integer, Class<? extends OpenSearchExceptionDup>>[] classes() {
        @SuppressWarnings("unchecked")
        final Tuple<Integer, Class<? extends OpenSearchExceptionDup>>[] ts =
            Arrays.stream(OpenSearchExceptionDupHandle.values())
    ...
    static {
        ID_TO_SUPPLIER = unmodifiableMap(Arrays
            .stream(OpenSearchExceptionDupHandle.values()).collect(Collectors.toMap(e -> e.id, e -> e.constructor)));
        CLASS_TO_OPENSEARCH_EXCEPTION_HANDLE = unmodifiableMap(Arrays
            .stream(OpenSearchExceptionDupHandle.values()).collect(Collectors.toMap(e -> e.exceptionClass, e -> e)));
    }
