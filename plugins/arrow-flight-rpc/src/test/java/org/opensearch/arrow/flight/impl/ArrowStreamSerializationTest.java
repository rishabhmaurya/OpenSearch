...
public class ArrowStreamSerializationTest extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        registry = new NamedWriteableRegistry(Arrays.asList(
    ...
    public void testInternalAggregationSerializationDeserialization() throws IOException {
        ...
        try (ArrowStreamOutput output = new ArrowStreamOutput()) {
        ...
        return new StringTerms(
            ...
            Arrays.asList(
                new StringTerms.Bucket(
                    new BytesRef("term1"),
                    100,
                    InternalAggregations.from(Collections.singletonList(
                        new StringTerms(
                            "sub_agg_1",
                            InternalOrder.key(true),
                            InternalOrder.key(true),
